...
sns.heatmap(matrix_IGs, cmap='seismic', center=0)
plt.title(f'IGs written in all sequence : class 5 ir 0001', fontsize=100)
plt.xlabel('data_num', fontsize=70)
plt.ylabel('sequence', fontsize=70)
savepath = './viz_analize_IGs.png'
